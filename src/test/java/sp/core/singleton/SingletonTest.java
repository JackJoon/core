...
public class SingletonTest {
    ...
    @Test
    @DisplayName("스프링 없는 순순한 DI 컨테이네")
    void pureContainer() {
        AppConfig appConfig = new AppConfig();

        //1.  조회 : 호출할 때 마다 객체를 생성
        MemberService memberSerivce1 = appConfig.memberService();
        ...
        System.out.println("memberService1 = " + memberSerivce1);
        System.out.println("memberService2 = " + memberSerivce2);


        //memberService1 != memberService2
        assertThat(memberSerivce1).isNotSameAs(memberSerivce2);
